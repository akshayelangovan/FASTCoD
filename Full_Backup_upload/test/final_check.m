tic
load('M9a.mat') % Trained controller chromosome + fitness || M9a - motion tracking in XZ, C3 - stabilization in XZ
...
[t,z]=ode45(@P.ode,P.tspan,X0,options,fis1,fis2,fis3,fis4,fis5,fis6,S);
