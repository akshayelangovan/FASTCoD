...
parfor i = 1 : P.M
    warning('off','all');
    fitness_hold(i) = FitFun( chromosomes_hold(i,:),P,P.fis1,P.fis2,P.fis3,P.fis4,P.fis5,P.initstate,P.costfuncname,S);
end
for i = 1 : P.M
...
for g = 2 : P.MaxGen
    ...
    parfor i = 1 : P.M
        fitness_hold(i) = FitFun( new_chromosome_hold(i,:),P,P.fis1,P.fis2,P.fis3,P.fis4,P.fis5,P.initstate,P.costfuncname,S);
    end
    for i=1:P.M
